...
doc.fill('#000').stroke();
doc.fontSize(10);
doc.text("Employer", 8, 100, {lineBreak: false} );
doc.text("Employer Address", 8, 120, {lineBreak: false} );
doc.text("Country", 8, 140, {lineBreak: false} );
doc.text("Pay Period", 8, 160, {lineBreak: false} );

doc.rect(150, 90, 200, 100).fillAndStroke('#FFFFFF', '#000');
doc.fill('#000').stroke();
doc.fontSize(8);
doc.text(resp[0].CompanyName, 158, 100, {lineBreak: false} );
doc.text(resp[0].Address, 158, 120, {lineBreak: false} );
doc.text(resp[0].Country, 158, 140, {lineBreak: false} );
doc.text(resp[0].Paidon, 158, 160, {lineBreak: false} );

//******************************************************* */
doc.rect(5, 200, 120, 60).fillAndStroke('#ddd', '#000');
doc.fill('#000').stroke();
doc.fontSize(10);
doc.text("Employee Name", 8, 210, {lineBreak: false} );
doc.text("Client Empl. ID ", 8, 230, {lineBreak: false} );


doc.rect(120, 200, 200, 60).fillAndStroke('#FFFFFF', '#000');
doc.fill('#000').stroke();
doc.fontSize(8);
doc.text(resp[0].EmployeeName, 158, 210, {lineBreak: false} );
doc.text(resp[0].EmployeeCode, 158, 230, {lineBreak: false} );

doc.rect(320, 200, 120, 60).fillAndStroke('#ddd', '#000');
doc.fill('#000').stroke();
doc.fontSize(10);
doc.text("Email ID", 325, 210, {lineBreak: false} );
doc.text("Hire Date", 325, 230, {lineBreak: false} );
...
doc.fill('#000').stroke();
doc.fontSize(8);
doc.text(resp[0].Email, 405, 210, {lineBreak: false} );
doc.text(resp[0].HireDate, 405, 230, {lineBreak: false} );
...
module.exports = { GetEmployeeReport, GetEmployeePayrollReport, GetEmployeeVarrianceReport ,getIndvVarriancereport,GetGTNReport,download,GetGLReport,GeneratePaySlip};